...
test('newly earned reroll makes a trapped placement amber',()=>{const g=trapped();g.board[0]=[0,1,1,1,1,1,1,1];g.board[1]=[0,1,1,1,1,1,1,1];g.pieces=[{shape:[[1],[1]],color:1},{shape:[[1,1,1],[1,1,1],[1,1,1]],color:2},null];assert.equal(placementRisk(g,0,0,0),'amber');});
