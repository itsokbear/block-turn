export type SoundKind='move'|'clear'|'celebrate'|'double'|'reroll';
export async function playEffect(context:AudioContext,kind:SoundKind,stillEnabled:()=>boolean){
 ...
 const frequencies=kind==='reroll'?[880,1320]:kind==='double'?[523.25,783.99]:kind==='celebrate'?[523.25,659.25,783.99]:[kind==='clear'?660:330];
 frequencies.forEach((frequency,i)=>{
  ...
  gain.gain.setValueAtTime(kind==='reroll'?.025:kind==='double'?.03:kind==='celebrate'?.035:.07,start);
