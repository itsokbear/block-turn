...
await writeFile(join(root,'sw.js'),template.replace('__CACHE_NAME__','block-turn-offline-'+encodeURIComponent(base+'/')+'-'+revision).replace('__ASSET_LIST__',JSON.stringify(assets)));
